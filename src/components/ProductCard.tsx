...
// Assuming a simplified Product interface for this context
...
export function ProductCard({ product, priority = false }: ProductCardProps) {
  ...
  return (
    <div className="group relative flex flex-col bg-[#FAFAFA]">
      {/* Image Container */}
      <Link href={`/products/${product.handle}`} className="block relative aspect-[4/5] overflow-hidden rounded-xl bg-[#F0F0F0] border border-[#E5E5E5] mb-4">
        {/* COD Badge */}
      ...
      <div className="flex flex-col px-1">
        <Link href={`/products/${product.handle}`} className="group-hover:opacity-80 transition-opacity">
