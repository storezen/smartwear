...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      >
        <SpotlightCard className="p-8 sm:p-10 relative overflow-hidden backdrop-blur-2xl bg-card/80">
          ...
          <div className="text-center mb-10">
            ...
            <motion.p
              ...
              className="text-foreground/60 text-sm tracking-widest uppercase"
            >
              Smartwear Admin
            </motion.p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 }} className="relative group">
              <div className="absolute left-4 top-1/2 -translate-y-1/2 text-foreground/60 group-focus-within:text-[#B8860B] transition-colors">
