...
export function WhatsAppButton() {
  ...
  let number = settings?.whatsapp_number?.replace(/[^0-9]/g, "") || ""
  ...
  else if (number.startsWith('92') && number.length < 13) number = number
  else if (!number.startsWith('92')) number = '92' + number
