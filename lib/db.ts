...
const INITIAL_DATA = {
  ...
  settings: {
    ...
    seo_description: "Pakistan's most trusted destination for premium smartwatches and accessories. Genuine products with nationwide delivery and open-box verification.",
    ...
    trust_badges: '[{"label":"Fast Delivery","icon":"Truck"},{"label":"1 Year Warranty","icon":"ShieldCheck"},{"label":"7-Day Returns","icon":"RefreshCw"},{"label":"Cash on Delivery","icon":"Banknote"},{"label":"Secure Checkout","icon":"Lock"}]',
    postex_api_token: "",
