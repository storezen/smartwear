  ...
  return (
    <InputPrimitive
      ...
      className={cn(
        ...
        "hover:border-input",
        "focus-visible:border-ring focus-visible:shadow-[0_0_0_2px_rgba(15,23,42,0.1)] focus-visible:outline-none",
        "disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-muted/50 disabled:opacity-50",
        "aria-invalid:border-destructive aria-invalid:shadow-[0_0_0_2px_rgba(239,68,68,0.1)]",
