  ...
  return (
    <div className="flex items-center gap-2.5">
      ...
      <div>
              ...
              <span
                className="block text-foreground/60 font-medium mt-0.5"
...
export function StoreFooter() {
  ...
  return (
    <footer className="relative overflow-hidden bg-background text-foreground">
      ...
      {/* Newsletter */}
      <div className="relative border-b border-border py-8 md:py-16">
        <div className="sw-container">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 bg-accent/5 border border-border backdrop-blur-xl p-6 md:p-8 rounded-[24px]">
            <div>
        ...
        <div className="sw-container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-8">
            ...
            <div className="lg:col-span-4 pr-4">
              ...
              <p className="text-foreground/60 text-sm mt-6 mb-8 leading-relaxed max-w-xs">
                {s.store_tagline 
                ...
                {buildSocial().map((soc) => {
                  ...
                  return (
                    <motion.a
                      ...
                      className={`w-10 h-10 rounded-full bg-accent/5 border border-border flex items-center justify-center text-foreground/70 transition-colors sw-interactive hover:bg-accent/10 hover:border-accent/20 ${soc.color}`}
                      title={soc.label}
                    >
            ...
            <div className="lg:col-span-2">
              <h4 className="text-foreground font-semibold mb-6 uppercase tracking-widest text-xs">The Collection</h4>
              <ul className="space-y-4">
                {collectionLinks.map(link => (
                  <li key={link.l}>
                    <Link href={link.h} className="text-foreground/60 hover:text-[#B8860B] text-sm transition-colors sw-interactive inline-block">
                      {link.l}
                    </Link>
                  </li>
                ))}
            ...
            <div className="lg:col-span-2">
              <h4 className="text-foreground font-semibold mb-6 uppercase tracking-widest text-xs">Account</h4>
              <ul className="space-y-4">
            ...
            <div className="lg:col-span-2">
              <h4 className="text-foreground font-semibold mb-6 uppercase tracking-widest text-xs">Support</h4>
              <ul className="space-y-4">
            ...
            {/* Contact Info */}
            <div className="lg:col-span-2">
              <h4 className="text-foreground font-semibold mb-6 uppercase tracking-widest text-xs">Contact</h4>
              <ul className="space-y-4">
                {s.support_email && (
                  <li>
                    <a href={`mailto:${s.support_email}`} className="flex items-center gap-3 text-foreground/60 hover:text-foreground text-sm transition-colors group sw-interactive">
                      <div className="w-8 h-8 rounded-full bg-accent/5 flex items-center justify-center group-hover:bg-[#B8860B]/20 group-hover:text-[#B8860B] transition-colors">
                ...
                {s.support_phone && (
                  <li>
                    <a href={`tel:${s.support_phone.replace(/\s/g, '')}`} className="flex items-center gap-3 text-foreground/60 hover:text-foreground text-sm transition-colors group sw-interactive">
                      <div className="w-8 h-8 rounded-full bg-accent/5 flex items-center justify-center group-hover:bg-[#B8860B]/20 group-hover:text-[#B8860B] transition-colors">
          ...
          <div className="sw-container">
            <div className="flex flex-wrap items-center justify-center gap-6">
              {badges.map((badge: { label: string; icon: string }, idx: number) => {
                ...
                return (
                  <div key={idx} className="flex items-center gap-2 text-foreground/40">
      ...
      <div className="relative border-t border-border py-6">
        <div className="sw-container flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-xs">
            <Link href="/about" className="text-foreground/60 hover:text-foreground transition-colors sw-interactive">About</Link>
            <span className="text-foreground/10">•</span>
            <Link href="/privacy-policy" className="text-foreground/60 hover:text-foreground transition-colors sw-interactive">Privacy</Link>
            <span className="text-foreground/10">•</span>
            <Link href="/terms" className="text-foreground/60 hover:text-foreground transition-colors sw-interactive">Terms</Link>
          </div>
        </div>
      </div>
    </footer>
