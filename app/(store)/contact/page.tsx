        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-24 items-start">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-foreground/60 leading-relaxed mb-1">{s?.support_phone || '+92 300 1234567'}</p>
              <p className="text-foreground/60 text-sm">{s?.business_hours || 'Mon-Sat: 10am - 8pm PKT'}</p>
            </motion.div>
          ...
          >
            ...
            {sent ? (
              <div className="text-center py-10">
                ...
                <p className="text-foreground/60">Thank you for reaching out. Our concierge team will respond within 24 hours.</p>
              </div>
            ) : (
